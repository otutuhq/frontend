...
export default defineNuxtConfig({
  ...
  runtimeConfig: {
    ...
    public: {
      baseUrl: '',
      contact: {
        bespokeEmail: 'bespoke-accounting@otutu.co',
        bespokeEmailMailTo: 'mailto:bespoke-accounting@otutu.co',
        discord: 'https://discord.otutu.co',
        email: 'info@otutu.co',
        emailMailto: 'mailto:info@otutu.co',
        github: 'https://github.com/otutuhq',
        supportEmail: 'support@otutu.co',
        supportEmailMailto: 'mailto:support@otutu.co',
